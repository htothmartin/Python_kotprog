...
class AllSprites(pygame.sprite.Group):
    ...
    def draw_clouds(self):
        ...
        for i in range(cloud_number):
            self.display_surf.blit(pygame.transform.scale_by(self.clouds['back'], multiplier), (i * new_width + 0 - self.offset.x, 0))
            self.display_surf.blit(pygame.transform.scale_by(self.clouds['front'], multiplier), (i * new_width + 0 - self.offset.x, 0))
