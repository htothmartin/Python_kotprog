...
class Game:
    def __init__(self):
        ...
        self.data = Data()
        self.level = Level(self.data.map, self.data.level_images, self.change_level, self.data.audio)
        self.running = False
        self.clock = pygame.time.Clock()
        self.data.audio['background_music'].set_volume(0.05)
        self.data.audio['background_music'].play()
    ...
    def change_level(self):
        ...
        self.level = Level(self.data.levels[self.data.current_level], self.data.level_images, self.change_level, self.data.audio)
